...
// whole app is bundled once (Rolldown, platform=node) and imported. The shell's
// frontend supplies react and the Apps SDK; in a plain checkout `npm install`
// plus MOBIUS_FRONTEND_NODE_MODULES resolves everything (see bundle.mjs).
